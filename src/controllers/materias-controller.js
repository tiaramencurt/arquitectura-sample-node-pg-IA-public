// [YO] Se normalizaron todos los req.params.id con parseInt() y se robusteció la validación del PUT
...
router.put('/:id', async (req, res) => {
    try {
        ...
        if (!entity.id || parseInt(entity.id) !== id) {
            return res.status(StatusCodes.BAD_REQUEST).send(`El id de la URL (${id}) debe coincidir obligatoriamente con el id del body (${entity.id ?? 'ausente'}).`);
        }
